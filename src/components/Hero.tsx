          ...
          <div className="flex flex-col items-start">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-4">
              <a href="#technologies">
                <button
                  type="button"
                  className="group inline-flex items-center gap-2 rounded-xl btn-gradient px-6 py-3 font-semibold text-white shadow-lg shadow-pink-500/20 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-xl hover:shadow-pink-500/30"
                >
